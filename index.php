...
<body>
    <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href="#">
            <img src="https://pics.craiyon.com/2023-09-29/1eecb043195844c186124cdedd36ef89.webp" width="30" height="30" class="d-inline-block align-top" alt="Softball Logo">
    ...
    <script>
        ...
        function showProductModal(title, price) {
            document.getElementById('modalBody').innerHTML = `
                <p>Name: ${title}</p>
                <p>Price: ₱${price}</p>`;
            document.getElementById('paymentLink').href = `admin/address/payment.php?productName=${encodeURIComponent(title)}&price=${encodeURIComponent(price)}`;
